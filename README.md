...
Commit Rule:
	...
	3. Create a branch with your name and title. For example: [ISSUE_NO]-[SHORT DESCRIPTION]. Always create a branch for any changes.
	...
	5. Create a pull request for every task. Assign to at least 1 colleagues for review. Make sure they all approve the change before it will be merged.
